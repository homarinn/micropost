...
ActiveRecord::Schema.define(version: 20190209083412) do
  ...
  create_table "favs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["like_id"], name: "index_favs_on_like_id", using: :btree
  ...
  add_foreign_key "favs", "microposts", column: "like_id"
